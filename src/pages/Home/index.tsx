...
const Home = () => {
    const [email, setEmail] = useState('');   //dalam Home komponen ini, terdapat dua state lokal yang menyimpan nilai dari email dan password, serta objek navigasi yang memungkinkan untuk mengarahkan navigasi di aplikasi.
