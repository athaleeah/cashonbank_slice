...
const CashOnBank = () => {                                  //fungsi dengan nama CashOnBank
    const [description, setDescription] = useState('');     // menyimpan informasi tentang jenis transaksi cth officle suplies/top up
    const [type, setType] = useState('');           
    const navigation = useNavigation();                     // melakukan navigasi antara layar-layar dalam aplikasi. 
    ...
    const handleSignIn = () => {   //Misalnya, dengan menggunakan navigation.navigate('Home'), kita dapat menavigasi pengguna kembali ke layar "Home" dalam aplikasi ketika suatu kondisi tertentu terpenuhi atau suatu aksi tertentu diambil.
        navigation.navigate('Home');
    };
//touchableOpacity = area yg bisa ditekan user /tombol ; mengarahakn tindakan yg akan terjadi selanjutnya
    return (
