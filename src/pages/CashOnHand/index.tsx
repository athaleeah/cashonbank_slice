...
const CashOnHand = () => {
    const [description, setDescription] = useState('');  // menyimpan informasi 
    const [type, setType] = useState('');       
    const navigation = useNavigation();         //atur navigasi
    ...
    return (
        <View style={styles.container}>
            <View style={styles.title}>
                ...
                <Text style={styles.titletext}>Cash On Hand</Text>
            </View>
